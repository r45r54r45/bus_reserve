...
<div class="col-xs-12" style="text-align:right">
  <span style="font-size:8px;">*메뉴 업데이트가 안 돼 있으면 여기서 확인해주세요. <a href="https://coop.yonsei.ac.kr:5013/Menu/Kukje.asp" target='_blank'>메뉴 확인</a></span>
</div>
...
<div class="modal-content" style="width:90%;margin:20px auto;">
  ...
  <div class="modal-body" style="padding:0">
    <img  style="    width: 100%;" src="http://screenshot.net/lm6xpbk.jpg" onclick="$('#myModal').modal('hide')">
  </div>
