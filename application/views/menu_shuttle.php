...
<!-- onclick="parent.moveto('/#more#notice#3');" -->
      <a  onclick="alert('점검 완료되었습니다!');" class="alert-link" style="font-size: 12px;font-weight: 100;text-decoration: none;">점검 완료</a>
    </div>
      <div class="full-width input-group">
        ...
        <!-- onkeydown=" input_range(event)" onkeyup="len_ch(10,'sid','idgl');"  maxlength="10" -->
