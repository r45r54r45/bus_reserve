...
class Data_model extends CI_Model{
	...
	return $this->db->query("select i.idx, i.n_timestamp, n.title, n.content, i.noticeId, i.check from notification i join notice n on n.idx=noticeId join cookie_user c on c.idx=read_user where read_user=$userIdx order by i.idx desc limit 10 ");
	}
